namespace ThreadedProject2 {
	partial class Suppliers {
		...
		private void InitializeComponent() {
			...
			this.LBSuppliers.SelectedValueChanged += new System.EventHandler(this.PickNewValue);
			// 
			// BtnCreate
			// 
			...
			this.CBYacht.Click += new System.EventHandler(this.Clicked);
			// 
			// CBTravel
			// 
			...
			this.CBTravel.Click += new System.EventHandler(this.Clicked);
			// 
			// CBTours
			// 
			...
			this.CBTours.Click += new System.EventHandler(this.Clicked);
			// 
			// CBRail
			// 
			...
			this.CBRail.Click += new System.EventHandler(this.Clicked);
			// 
			// CBMotor
			// 
			...
			this.CBMotor.Click += new System.EventHandler(this.Clicked);
			// 
			// CBHotel
			// 
			...
			this.CBHotel.Click += new System.EventHandler(this.Clicked);
			// 
			// CBCruise
			// 
			...
			this.CBCruise.Click += new System.EventHandler(this.Clicked);
			// 
			// CBCar
			// 
			...
			this.CBCar.Click += new System.EventHandler(this.Clicked);
			// 
			// CBAttractions
			// 
			...
			this.CBAttractions.Click += new System.EventHandler(this.Clicked);
			// 
			// CBAir
			// 
			...
			this.CBAir.Click += new System.EventHandler(this.Clicked);
			// 
			// button1
			// 
